...
def fake_data():
    ...
    for i in range(n):
        ...
        nlink = LinkNode(u)
        ntree = TreeNode(u)
        r1 = array_add(global_val_dev.get_user_array(), u)
        global_val_dev.set_user_array(r1)
        r2 = link_add(global_val_dev.get_user_link(), nlink)
        global_val_dev.set_user_link(r2)
        r3 = tree_add(global_val_dev.get_user_tree(), ntree)
        global_val_dev.set_user_tree(r3)
